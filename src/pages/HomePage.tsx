    ...
    <div className="space-y-16 pb-16">
      ...
      <section className="relative min-h-[85vh] flex items-center justify-center pt-8 pb-16 px-4 bg-mandala border-b border-amber-900/15 overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto text-center space-y-8 z-10">
          ...
          <div className="inline-flex items-center gap-3 px-4 py-1.5 rounded-full bg-amber-500/10 border border-amber-800/20 text-amber-200 text-xs font-serif shadow-sm">
            <Diya size="sm" />
          ...
          <div className="space-y-3">
            <h1 className="font-serif text-4xl sm:text-6xl md:text-7xl font-bold tracking-tight text-amber-100 sanskrit-font leading-tight">
              सनातन कोषः
            </h1>
            <p className="text-sm sm:text-base md:text-lg text-amber-300/90 max-w-2xl mx-auto font-serif leading-relaxed">
          ...
          <div className="max-w-3xl mx-auto bg-stone-900/80 border border-amber-800/20 rounded-2xl p-4 sm:p-6 shadow-xl backdrop-blur-sm text-left">
            ...
            <div className="space-y-3">
              ...
              <div className="pt-2 flex items-center justify-between">
                <div className="flex gap-2 text-[11px] text-amber-300 font-medium">
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-3 pt-2">
            ...
            <Link
              to="/geography"
              className="px-5 py-3.5 min-h-[48px] rounded-xl bg-stone-800 text-stone-200 border border-amber-800/20 hover:border-amber-600 font-serif font-medium text-sm transition-all flex items-center justify-center gap-2 shadow-sm active:scale-98"
            >
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        {/* Panchang Bar */}
        <div className="bg-stone-900/80 border border-amber-800/20 rounded-2xl p-5 shadow-md">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div className="flex items-center gap-2">
              <Sun className="w-5 h-5 text-amber-400" />
              <div>
                <span className="text-xs font-bold uppercase tracking-wider text-amber-300 font-serif block">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-xs font-serif">
              <div className="px-3 py-1.5 rounded-xl bg-amber-500/10 border border-amber-500/10">
                <span className="text-stone-400 block text-[9px]">TITHI</span>
                <span className="font-bold text-amber-100">
                  {panchang.tithi.name} ({panchang.tithi.paksha})
                </span>
              </div>
              <div className="px-3 py-1.5 rounded-xl bg-amber-500/10 border border-amber-500/10">
                <span className="text-stone-400 block text-[9px]">NAKSHATRA</span>
                <span className="font-bold text-amber-100">
                  {panchang.nakshatra.name}
                </span>
              </div>
              <div className="px-3 py-1.5 rounded-xl bg-amber-500/10 border border-amber-500/10">
                <span className="text-stone-400 block text-[9px]">YOGA</span>
                <span className="font-bold text-amber-100">{panchang.yoga}</span>
              </div>
              <div className="px-3 py-1.5 rounded-xl bg-amber-500/10 border border-amber-500/10">
                <span className="text-stone-400 block text-[9px]">RAHUKAAL</span>
                <span className="font-bold text-amber-100">{panchang.rahukaal}</span>
              </div>
            </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        <div className="text-center space-y-2">
          ...
          <p className="text-xs sm:text-sm text-stone-400 font-serif max-w-xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {[
            ...
            <Link
              key={idx}
              to={item.path}
              className="group p-6 rounded-2xl bg-stone-900/80 border border-amber-800/20 hover:border-amber-600 transition-all shadow-md hover:shadow-xl hover:-translate-y-1 flex flex-col justify-between"
            >
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <span className="font-serif text-lg font-bold text-amber-100 group-hover:text-amber-400 transition-colors">
                    {item.title}
                  </span>
                  <span className="text-xs text-amber-300 font-serif sanskrit-font">
                    {item.sanskrit}
                  </span>
                </div>
              ...
              <div className="pt-4 mt-4 border-t border-amber-900/10 flex items-center justify-between text-xs text-amber-400 font-medium">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
        <div className="p-8 rounded-3xl bg-stone-900 border border-amber-800/20 shadow-xl space-y-6">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-amber-900/15 pb-4">
            ...
            <p className="text-xs text-stone-300 font-serif max-w-md">
